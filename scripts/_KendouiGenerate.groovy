...
def generateForDomainClass(domainClass) {
	def templateGenerator = classLoader.loadClass("org.grails.plugin.kendoui.scaffolding.KendouiGrailsTemplateGenerator").newInstance([classLoader] as Object[])
	templateGenerator.grailsApplication = grailsApp
	templateGenerator.pluginManager = pluginManager
	templateGenerator.kendouiPluginDir = kendouiPluginDir
	if (generateViews) {
